...
-(id) init {
    ...
    */
    ...
    CCLabelTTF *someLabel_05 = [CCLabelTTF labelWithString:@"Your damage" fontName:@"Helvetica" fontSize:16 dimensions:CGSizeMake(140.0, 80.0) hAlignment:kCCTextAlignmentLeft];
